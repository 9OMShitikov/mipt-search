...
std::unordered_map<uint32_t, std::vector<Hit>> RamSegment::GetQueryHits(const Query &tQuery) {
...
void RamSegment::AddField(const String & sField, uint32_t iDocumentId, uint8_t iFieldId) {
	// Your code goes here...
